...
<head>
    ...
    <style>
        ...
        h1, h2, h3 {
            color: #333;
            position: relative; /* Ensure headings are above watermark */
            z-index: 1;
        }
        p {
            color: #555;
            position: relative; /* Ensure paragraphs are above watermark */
            z-index: 1;
        }
        /* Watermark */
        .watermark {
            ...
            opacity: 0.2;
            z-index: 0;
            pointer-events: none; /* Make sure watermark doesn't interfere with clicks */
        }
    </style>
</head>
<body>
